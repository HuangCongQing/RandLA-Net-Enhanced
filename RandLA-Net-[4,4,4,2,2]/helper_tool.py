...
class ConfigSemanticKITTI:
    ...
    sub_sampling_ratio = [4, 4, 4, 2, 2]  # sampling ratio of random sampling at each layer
    d_out = [16, 64, 128, 256, 512]  # feature dimension
    num_sub_points = [num_points // 4, num_points // 16, num_points // 64, num_points // 128, num_points // 256]
