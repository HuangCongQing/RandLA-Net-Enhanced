...
@Author: HCQ
@Company(School): UCAS
@Date: 2020-05-23 18:15:22
@LastEditors: HCQ
@LastEditTime: 2020-05-23 18:51:11
'''
...
for seq_id in seq_list:
    ...
    normal_path_out = join(seq_path_out, 'normals')
    ...
    os.makedirs(normal_path_out) if not exists(normal_path_out) else None
    ...
    if int(seq_id) < 11:
        ...
        for scan_id in scan_list:
            ...
            sub_normals = DP.calculate_pc_normals(sub_points)
            ...
            np.save(join(normal_path_out, scan_id)[:-4], sub_normals)
